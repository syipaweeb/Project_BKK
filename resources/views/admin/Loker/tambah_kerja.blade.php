                            ...
                            <form action="{{ route('loker.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="nama_perusahaan" id="nama_perusahaan" class="form-control">
                                        ...
                                        @foreach ($data_mitras as $key => $DataMitra)
                                            <option value="{{ $DataMitra->nama_perusahaan }}">
                                                {{ $DataMitra->nama_perusahaan }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mt-3">
                                    ...
                                    <textarea type="text" class="form-control @error('deskripsi') is-invalid @enderror"name="deskripsi"
                                        value="{{ old('deskripsi_perusahaan') }}" name="nama" placeholder="Masukkan Deskripsi"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"class="form-control @error('rentang_gaji') is-invalid @enderror"
                                        name="rentang_gaji"
                                        value="{{ old('rentang_gaji') }}"placeholder="Masukkan Rentang gaji ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"class="form-control @error('jadwal_tes') is-invalid @enderror"
                                        name="jadwal_tes"
                                        value="{{ old('jadwal_tes') }}"placeholder="Masukkan Jadwal tes ">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div>
                                        <div class="" id="date-range">
                                            <input
                                                type="date"class="form-control @error('batas_awal') is-invalid @enderror"
                                                name="batas_awal"
                                                value="{{ old('batas_awal') }}"placeholder="Masukkan batas awal ">
                                            ...
                                            @enderror <input
                                                type="date"class="form-control @error('batas_akhir') is-invalid @enderror"
                                                name="batas_akhir"
                                                value="{{ old('batas_akhir') }}"placeholder="Masukkan Batas akhir ">
                                ...
                                <a href="{{ route('loker.index') }}" type="submit"
