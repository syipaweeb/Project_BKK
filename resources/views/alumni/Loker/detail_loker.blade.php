                        ...
                        <div class="col-lg-6 col-md-12">
                            ...
                            <div class="widget widget_about">
                                <div class="logo-footer clearfix">
                                    <a href="index.html"><img src="{{ asset('alumni/assetsimages/logo bkk.png') }}"
                                            alt=""></a>
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body wt-panel-body p-a20 ">
                                    ...
                                    <div class="twm-tabs-style-1">
                                        ...
                                        <div class="row">
                                            <form action="{{ route('pelamar_alumni') }}" method="POST"
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('nama_pelamar', auth()->user()->name) }}"
                                                            name="nama" placeholder="Masukkan Nama pelamar">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('alamat', auth()->user()->profil->lokasi) }}"
                                                            name="nama" placeholder="Masukkan alamat">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input
                                                            type="text"class="form-control @error('nomor_telepon') is-invalid @enderror"
                                                            name="nomor_telepon"
                                                            value="{{ old('nomor_telepon', auth()->user()->nomor_telepon) }}"placeholder="Masukkan nomor telepon">
                                                ...
                                                <div class="mb-3">
                                                    <label for="formFile" class="form-label">Masukan CV</label>
