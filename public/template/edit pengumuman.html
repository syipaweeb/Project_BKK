<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from mannatthemes.com/zoogler/vertical/tables-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2024 10:32:26 GMT -->
...
<body class="fixed-left"><!-- Loader -->
            ...
            <div class="left side-menu"><button type="button"
                ...
                <div class="topbar-left">
                    <div class="text-center bg-logo">
                        <a href="index.html" class="logo"><img src="assets/images/Logo BKK.png" height="80"
                                alt="logo"></a>
                    </div>
                </div>
                <!-- Logo admn -->
                    ...
                    <nav class="navbar-custom">
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list"><a
                                    ...
                                    aria-expanded="false"><img src="assets/images/users/avatar-6.jpg" alt="user"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form>
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Poto</label>
                                            ...
                                            <a href="pengumuman.html" type="submit"
    ...
    <script src="assets/js/jquery.blockUI.js"></script>
    <script src="assets/js/waves.js"></script>
    <script src="assets/js/jquery.scrollTo.min.js"></script><!--Summernote js-->
